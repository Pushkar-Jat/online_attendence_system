		...
		<div class="container">
			...
			<div class="row inner-sec">
				...
				<div class="col-lg-8 left-blog-info-w3layouts-agileits text-left">
                    ...
                    <div>
                    <p class="tittle" >This site is developed under the college project with refrence of the HOD and DEAN of  college.
                        it is constructed for the college blog and latest information.
                        it is construted by <i>pushkar jat and Ajay gauttam</i>.
                        </p>
                    </div>
				</div>
				<!--//left-->
